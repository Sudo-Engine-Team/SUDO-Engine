...
public class LWJGL {
	...
	public LWJGL(){
        ...
        RawModel model = OBJLoader.loadObjModel("res/model/stall.obj", l);
         
        TexturedModel staticModel = new TexturedModel(model,new ModelTexture(l.loadTexture("res/image/stallTexture.png")));
