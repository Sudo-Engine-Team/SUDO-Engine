...
public class HeightMapTerrain extends Terrain{
	...
	public HeightMapTerrain(int gridX, int gridZ, Loader loader, ModelTexture texture, int vertexCount) {
		super(gridX, gridZ, loader, texture, vertexCount);
	}

	protected RawModel generateTerrain(Loader loader){ // Flat Terrain
